...
var staticRangeHandler = {
  ...
  isSelected: function isSelected(range) {
    ...
    if (range.startDate === null && range.endDate) {
      return range.startDate === definedRange.startDate && (0, _isSameDay2.default)(range.endDate, definedRange.endDate);

      // Infinity Future
    } else if (range.endDate === null && range.startDate) {
      return range.endDate === definedRange.endDate && (0, _isSameDay2.default)(range.startDate, definedRange.startDate);
